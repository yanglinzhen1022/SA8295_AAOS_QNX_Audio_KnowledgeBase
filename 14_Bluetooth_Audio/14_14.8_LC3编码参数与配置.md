...
[`AudioSystem.bluetoothCodecToAudioFormat()`](framework/base/core/java/android/media/AudioSystem.java)执行A2DP映射，LC3映射通过LeAudioCodecConfig.getCodecConfigOffloading()获取。
