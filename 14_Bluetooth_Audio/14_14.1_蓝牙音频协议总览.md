...
转换逻辑：`btCodecConfig.getCodecType()` → [`AudioSystem.bluetoothCodecToAudioFormat()`](frameworks/base/media/java/android/media/AudioSystem.java) → 返回`@AudioFormatNativeEnumForBtCodec int`
