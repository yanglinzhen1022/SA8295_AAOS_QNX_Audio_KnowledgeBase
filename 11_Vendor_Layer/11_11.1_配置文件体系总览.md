...
| audio_policy_engine_configuration.xml | [`EngineBase.cpp`](frameworks/av/services/audiopolicy/engine/common/src/EngineBase.cpp) | `setStrategy()` |
...
| audio_effects.xml | [`EffectsFactory.cpp`](frameworks/av/media/libeffects/factory/EffectsFactory.c) | `loadEffectConfig()` |
