...
> - [`CarAudioVolumeGroup.java`](packages/services/Car/service/src/com/android/car/audio/CarAudioVolumeGroup.java)（具体子类，238行）
> - [`CarAudioDeviceInfo.java`](packages/services/Car/service/src/com/android/car/audio/CarAudioDeviceInfo.java)（设备信息封装，~220行）
