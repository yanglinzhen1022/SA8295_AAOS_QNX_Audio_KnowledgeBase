...
[`CarAudioZone`](packages/services/Car/service/src/com/android/car/audio/CarAudioZone.java:47)封装了一个车载音频Zone的全部信息：
...
CarAudioZone与OccupantZone通过[`CarOccupantZoneService`](packages/services/Car/service/src/com/android/car/occupantzone/CarOccupantZoneService.java)建立映射：
