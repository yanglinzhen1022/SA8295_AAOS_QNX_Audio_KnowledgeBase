## O.6 systrace/perfetto音频追踪

> [← 上一个](17_5.1_性能优化建议.md) | [返回目录](README.md) | [下一个 →](17_7.1_AudioFlinger详细dump解读.md)
...
O.6.2 AudioFlinger PlaybackThread Trace点
...
O.6.3 FastMixer/FastThread Trace点
