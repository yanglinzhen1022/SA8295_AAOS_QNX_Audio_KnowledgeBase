...
[`EngineInterface`](frameworks/av/services/audiopolicy/engine/interface/EngineInterface.h) 是Audio Policy Engine的**纯虚接口类**，定义了策略引擎与[`AudioPolicyManager`](frameworks/av/services/audiopolicy/managerdefault/AudioPolicyManager.h)之间的完整契约。其核心设计哲学为：
