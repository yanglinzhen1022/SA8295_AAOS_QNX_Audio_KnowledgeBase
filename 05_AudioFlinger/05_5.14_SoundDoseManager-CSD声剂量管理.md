...
- [`SoundDoseManager.cpp`](frameworks/av/services/audioflinger/sounddose/SoundDoseManager.cpp) (569行)
...
[`removeStreamProcessor()`](frameworks/av/services/audioflinger/sounddose/SoundDoseManager.cpp:135) 在MEL计算停止时移除流处理器：
...
[`setHalSoundDoseInterface()`](frameworks/av/services/audioflinger/sounddose/SoundDoseManager.cpp:79) 设置HAL侧的`ISoundDose`接口：
