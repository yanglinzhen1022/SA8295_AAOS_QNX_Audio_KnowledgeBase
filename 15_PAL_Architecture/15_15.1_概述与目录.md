...
| `ResourceManager` | 管理器 | 全局资源调度、并发控制、路由决策 | [15.6](15_15.6_架构地位.md) |
| `PayloadBuilder` | 构建器 | 构建 GSL/APM 命令载荷 | [15.7](15_15.7_核心职责.md) |
...
| 15.6 | ResourceManager 架构地位 | [15_6](15_15.6_架构地位.md) | ResourceManager 在 PAL 中的核心调度地位和全局职责 |
| 15.7 | ResourceManager 核心职责 | [15_7](15_15.7_核心职责.md) | ResourceManager 详细职责：并发控制、路由决策、FE ID 分配 |
...
| 15.10 | HAL-PAL适配层架构 | [15_10](15_15.10_架构.md) | PAL 内部架构细节，模块间交互流程 |
