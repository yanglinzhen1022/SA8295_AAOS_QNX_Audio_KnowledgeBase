...
> [← 上一个](../14_Bluetooth_Audio/README.md) | [← 返回15章](README.md) | [返回导航](../README.md) | [下一个 →](15_2.1_架构层次图.md)
...
| 类名 | 层级 | 核心职责 | 章节链接 |
|------|------|---------|---------|
| `Stream` | Stream 基类 | 音频流抽象，定义 open/start/stop/close 生命周期 | [15.5](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `StreamPCM` | Stream 子类 | PCM 数据流，支持低延迟和深缓冲两种模式 | [15.5](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `StreamCompress` | Stream 子类 | Compress Offload 流，编码数据直接传 DSP | [15.5](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `StreamSoundTrigger` | Stream 子类 | 语音唤醒流，与 Sound Trigger HAL 交互 | [15.5](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `Device` | Device 基类 | 音频端点设备抽象 | [15.6](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `Speaker` | Device 子类 | 扬声器设备，包含保护算法 | [15.6](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `Bluetooth` | Device 子类 | 蓝牙设备，支持 A2DP/HFP/LE Audio | [15.6](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `Session` | Session 基类 | 音频会话抽象，连接 Stream 和 Device | [15.7](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `SessionAlsaPcm` | Session 子类 | ALSA PCM 会话实现 | [15.7](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `SessionAlsaCompress` | Session 子类 | ALSA Compress 会话实现 | [15.7](15_5.1_核心类层次图-Stream-Device-Session.md) |
| `ResourceManager` | 管理器 | 全局资源调度、并发控制、路由决策 | [15.6](15_6.1_架构地位.md) |
| `PayloadBuilder` | 构建器 | 构建 GSL/APM 命令载荷 | [15.7](15_7.1_核心职责.md) |
...
| 节号 | 标题 | 文件 | 核心内容 |
|------|------|------|---------|
| 15.1 | 概述与目录 | [15_1](15_1.1_概述与目录.md) | PAL 定义、历史演进、SA8295 虚拟化、源码结构、章节导航 |
| 15.2 | 架构层次图 | [15_2](15_2.1_架构层次图.md) | PAL 在整体音频架构中的位置，分层架构图解 |
| 15.3 | API 分类总览 | [15_3](15_3.1_API_分类总览.md) | pal_api.h 公共 API 分类，Stream/Device/Session API 详解 |
| 15.4 | 流类型 pal_stream_type_t | [15_4](15_4.1_流类型_pal_stream_type_t.md) | 30+ 流类型枚举详解，各流类型的用途和参数特征 |
| 15.5-15.7 | 核心类层次图 | [15_5](15_5.1_核心类层次图-Stream-Device-Session.md) | Stream/Device/Session 三层类层次、状态机、工厂方法 |
| 15.6 | ResourceManager 架构地位 | [15_6](15_6.1_架构地位.md) | ResourceManager 在 PAL 中的核心调度地位和全局职责 |
| 15.7 | ResourceManager 核心职责 | [15_7](15_7.1_核心职责.md) | ResourceManager 详细职责：并发控制、路由决策、FE ID 分配 |
| 15.8 | HIDL 接口定义 | [15_8](15_8.1_HIDL_接口定义.md) | HwBinder IPC 接口定义，pal_xml_api.xml 协议详解 |
| 15.9 | 配置文件列表 | [15_9](15_9.1_配置文件列表.md) | resource_manager.xml / mixer_paths.xml / audio_policy_configuration.xml 等 |
| 15.10 | HAL-PAL适配层架构 | [15_10](15_10.1_架构.md) | PAL 内部架构细节，模块间交互流程 |
| 15.11 | 编解码器插件 | [15_11](15_11.1_编解码器插件_pluginscodecs.md) | plugins/codecs/ 下的 AAC/MP3/FLAC 等编解码器插件实现 |
| 15.12 | QC audio-alsa | [15_12](15_12.1_QC_audio-alsa_ALSA层实现.md) | ALSA 用户空间封装层，mixer 控制与 PCM 操作封装 |
| 15.13 | QC GEF | [15_13](15_13.1_QC_GEF_通用音效框架.md) | Generic Effect Framework，动态音效加载与 CAPIv2 集成 |
| 15.14 | QC audio-parsers | [15_14](15_14.1_QC_audio-parsers_音频解析器.md) | 音频帧格式解析器，支持 MPEG/AAC/FLAC 等格式帧头解析 |
| 15.15 | QC CAPIv2 | [15_15](15_15.1_QC_CAPIv2_编解码接口.md) | Codec API v2 标准，capi_v2_t 结构体与生命周期管理 |
| 15.16 | QC CASA | [15_16](15_16.1_QC_CASA_校准配置工具.md) | 校准配置与数据管理，ACDB 数据库操作接口 |
| 15.17 | QC Sound Trigger HAL | [15_17](15_17.1_QC_Sound_Trigger_HAL.md) | 语音触发 HAL 实现，SVA/Smart Detect 与 PAL SoundTrigger 集成 |
| 附录 | Stream-Session-Device 映射 | [15_99](15_99.1_附录_Stream-Session-Device映射关系.md) | 各流类型与 Session/Device 的完整映射关系表 |
