...
> [← 上一个](15_1.1_概述与目录.md) | [← 返回15章](README.md) | [返回导航](../README.md) | [下一个 →](15_3.1_API_分类总览.md)]
...
| `SessionGsl` | Legacy 平台 | 直接调用 GSL API |
| `SessionAgm` | AudioReach 平台非PCM流 | 通过 AGM Service 操作 |
