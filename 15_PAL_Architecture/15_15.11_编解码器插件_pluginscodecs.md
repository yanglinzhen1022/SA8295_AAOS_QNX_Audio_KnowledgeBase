...
> [← 上一个](15_15.10_架构.md) | [返回目录](README.md) | [下一个 →](15_15.12_QC_audio-alsa_ALSA层实现.md)
...
sequenceDiagram
    ...
    participant Session as SessionAlsaCompress
    ...
    Stream->>Session: Session::makeSession() -> new SessionAlsaCompress
