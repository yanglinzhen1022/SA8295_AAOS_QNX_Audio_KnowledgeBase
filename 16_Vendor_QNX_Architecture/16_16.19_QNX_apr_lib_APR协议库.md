...
> **真实磁盘路径（对照源码）**：`Qnx/apps/qnx_ap/AMSS/multimedia/audio/audio_elite/audio_driver/apr_lib/`，实际顶层为 `b-family/`、`Makefile`。APR 协议实现位于 `b-family/apr/` 之下。下方 `vendor/qcom/proprietary/apr_lib/` 为逻辑归类路径，磁盘实际路径以上述 QNX 源码树为准。
