[← N.12 Android+QNX双域架构](16_12.1_Android+QNX双域架构总结.md) | [← 返回SA8295 Vendor+QNX双域音频架构深度解析](README.md) | [返回导航](../README.md) | [N.14 GSL(Graph Servi →](16_14.1_GSLGraph_Service_Layer内部架.md)

---

N.13 Primary HAL(AudioReach版)深度解析
...
N.13.6 Primary HAL(AR版) vs Legacy版对比
