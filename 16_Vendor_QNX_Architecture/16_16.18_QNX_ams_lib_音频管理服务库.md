...
> **真实磁盘路径（对照源码）**：`Qnx/apps/qnx_ap/AMSS/multimedia/audio/audio_elite/audio_driver/ams_lib/`，实际顶层为 `inc/`、`src/`、`aarch64/`、`common.mk`、`Makefile`。下方 `vendor/qcom/proprietary/ams_lib/` 为逻辑归类路径，磁盘实际路径以上述 QNX 源码树为准。
