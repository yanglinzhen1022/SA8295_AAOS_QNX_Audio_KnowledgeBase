[← 上一个](16_18.1_QNX_ams_lib_音频管理服务库.md) | [← 返回16章](README.md) | [返回导航](../README.md) | [下一个 →](16_20.1_QNX_audio_a2b_A2B总线音频.md)

## N.19 apr_lib — QNX APR协议库
...
| AGMAudio/SessionGsl | 被调用 | 通过apr_lib控制ADSP上的GSL模块 |
...
graph TB
    subgraph QNX_PVM[QNX PVM - Primary VM]
        ...
        session_gsl[SessionGsl<br/>GSL会话]
...
### 16.19.5 Domain/Port/Address三级寻址规则
...
### 16.19.23 APRv2与audio_driver_vm交互
...
### 16.19.27 Calibration Service交互
