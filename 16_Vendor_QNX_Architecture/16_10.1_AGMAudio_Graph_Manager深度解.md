[← N.9 auto-casa-xml配置](16_9.1_auto-casa-xml配置.md) | [← 返回SA8295 Vendor+QNX双域音频架构深度解析](README.md) | [返回导航](../README.md) | [N.11 SessionGsl与GSL接 →](16_11.1_SessionGsl与GSL接口.md)

---

N.10 AGM(Audio Graph Manager)深度解析
...
N.10.6 AudioReach vs Legacy架构对比
