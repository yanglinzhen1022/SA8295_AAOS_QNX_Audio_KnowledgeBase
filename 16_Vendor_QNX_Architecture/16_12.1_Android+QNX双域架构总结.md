[← N.11 SessionGsl与GSL接](16_11.1_SessionGsl与GSL接口.md) | [← 返回SA8295 Vendor+QNX双域音频架构深度解析](README.md) | [返回导航](../README.md) | [N.13 Primary HAL(Aud →](16_13.1_Primary_HALAudioReach版深度解.md)

---

N.12 Android+QNX双域架构总结
