...
> 对外公共 API 为 **`gsl_open()`**，启动无独立 `gsl_start()` API，而是通过
...
> **源码说明**：真实枚举见 [`gsl_vm_msg.h`](Qnx/apps/qnx_ap/AMSS/multimedia/audio/audio_ar/audio_driver/gsl_be/inc/gsl_vm_msg.h:52)：
...
> **源码说明**：audio_driver_vm 真实目录
> [`audio_driver_vm/`](Qnx/apps/qnx_ap/AMSS/multimedia/audio/audio_elite/audio_driver_vm) 的实际子模块为：
