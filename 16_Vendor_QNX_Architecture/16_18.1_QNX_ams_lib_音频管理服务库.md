[← 上一个](16_17.1_QNX_audio_service_vm_VM音频服务.md) | [← 返回16章](README.md) | [返回导航](../README.md)
...
| AGMAudio/SessionGsl | 链接调用 | 图管理器使用ams_lib的底层图操作能力 |
...
graph TB
    subgraph QNX_PVM[QNX PVM - Primary VM]
        ...
        agm[AGMAudio/SessionGsl<br/>图管理器]
