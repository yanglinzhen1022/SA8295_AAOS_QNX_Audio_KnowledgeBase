[← 返回16章](README.md) | [返回导航](../README.md) | [16.2 auto-audiod守护进程 →](16_2.1_auto-audiod守护进程.md)
...
| 组件 | 所属域 | 层级 | 核心职责 | 章节链接 |
|------|--------|------|---------|---------|
| auto-audiod | QNX | 守护进程 | 声卡状态监控、SSR恢复触发、静音启动控制 | [16.2](16_2.1_auto-audiod守护进程.md) |
| AutoPower | QNX | 守护进程 | 电源状态管理、VHAL集成、休眠唤醒音频恢复 | [16.3](16_3.1_AutoPower与VHAL集成.md) |
| Silent Boot | QNX | 监控机制 | 启动期间静音控制、防止爆音 | [16.4](16_4.1_Silent_Boot监控.md) |
| audio-chime | QNX | 守护进程 | 早期启动提示音播放、不依赖Android | [16.5](16_5.1_audio-chime早期提示音.md) |
| acdb-loader | QNX | 工具 | ACDB校准数据加载到共享内存 | [16.6](16_6.1_ACDB校准体系.md) |
| acdb-mcs | QNX | 工具 | 多校准存储(Multi-Calibration Store) | [16.6](16_6.1_ACDB校准体系.md) |
| acdb-fts | QNX | 工具 | ACDB文件传输服务 | [16.6](16_6.1_ACDB校准体系.md) |
| acdb-rtac | QNX | 工具 | 运行时ACDB校准更新 | [16.6](16_6.1_ACDB校准体系.md) |
| ALSA UCM | QNX | 配置层 | ALSA用例管理、路由配置 | [16.8](16_8.1_ALSA_UCM配置.md) |
| auto-casa-xml | QNX | 配置层 | 音频流/设备资源配置 | [16.9](16_9.1_auto-casa-xml配置.md) |
| AGM Service | QNX | 服务 | Audio Graph Manager，Graph生命周期管理 | [16.10](16_10.1_AGMAudio_Graph_Manager深度解.md) |
| SessionGsl | QNX | 库 | GSL接口封装，Graph操作API | [16.11](16_11.1_SessionGsl与GSL接口.md) |
| gsl_fe | Android | 库 | GSL VM前端，HAB发送端 | [16.13](16_13.1_Primary_HALAudioReach版深度解.md) |
| gsl_vm_be | QNX | 服务 | GSL VM后端，HAB接收端 | [16.14](16_14.1_GSLGraph_Service_Layer内部架.md) |
| QNX audio_driver_vm | QNX | 驱动 | VM音频驱动层 | [16.16](16_16.1_QNX_audio_driver_vm_VM音频驱动层.md) |
| QNX audio_service_vm | QNX | 服务 | VM音频服务 | [16.17](16_17.1_QNX_audio_service_vm_VM音频服务.md) |
| QNX ams_lib | QNX | 库 | 音频管理服务库 | [16.18](16_18.1_QNX_ams_lib_音频管理服务库.md) |
| QNX apr_lib | QNX | 库 | APR协议库(ADSP通信) | [16.19](16_19.1_QNX_apr_lib_APR协议库.md) |
| QNX audio_a2b | QNX | 驱动 | A2B总线音频驱动 | [16.20](16_20.1_QNX_audio_a2b_A2B总线音频.md) |
| QNX audio_dac | QNX | 驱动 | DAC音频驱动 | [16.21](16_21.1_QNX_audio_dac_DAC音频驱动.md) |
| QNX audio_expander | QNX | 驱动 | 音频扩展器驱动 | [16.22](16_22.1_QNX_audio_expander_音频扩展器.md) |
