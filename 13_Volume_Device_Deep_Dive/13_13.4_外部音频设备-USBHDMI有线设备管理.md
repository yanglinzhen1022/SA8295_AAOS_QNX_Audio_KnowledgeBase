...
flowchart TB
    ...
    Note over NORMAL: USB_HEADSET通常是<br>普通设备(非绝对/非固定)
```
...
flowchart LR
    ...
    Note over ARC_OUT: 最大采样率48kHz<br>PCM或压缩编码
    Note over EARC_OUT: 最大采样率192kHz<br>Dolby Atmos/DTS:X支持
```
...
flowchart TB
    ...
    Note over P1: 通话场景优先级:<br>SCO > USB > WIRED > A2DP > SPEAKER
    Note over P4: 娱乐场景优先级:<br>USB > WIRED > A2DP > HDMI > SPEAKER
```
